...
function nav(path) {
    ...
    <a href="https://netflix.com/" target="_blank" class="mdui-btn mdui-btn-icon mdui-ripple mdui-ripple-white" mdui-tooltip="{content: 'NF'}">
...
function file_video(path){
	...
	if (/(iPhone|iPad|iPod|iOS|Android)/i.test(navigator.userAgent)) {
		...
		<li class="mdui-menu-item"><a href="intent:${url}#Intent;package=package=com.instantbits.cast.webvideo;S.title=${path};end" class="mdui-ripple">Cast</a></li>
		<li class="mdui-menu-item"><a href="nplayer-${url}" class="mdui-ripple">nPlayer</a></li>
